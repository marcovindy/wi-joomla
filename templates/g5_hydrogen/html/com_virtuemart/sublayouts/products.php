...
foreach ($viewData['products'] as $type => $products ) {
	...
	<div class="product vm-col<?php echo ' vm-col-' . $products_per_row . $show_vertical_separator ?>">
		<div class="spacer product-container card d-" data-vm="product-container">
			<div class="vm-product-media-container card-image d-flex-center">
				...
				<div class="card-main vm-product-descr-container-<?php echo $rowsHeight[$row]['product_s_desc'] ?>">
					<h2 class="card-main-title"><?php echo JHtml::link ($product->link.$ItemidStr, $product->product_name); ?></h2>
